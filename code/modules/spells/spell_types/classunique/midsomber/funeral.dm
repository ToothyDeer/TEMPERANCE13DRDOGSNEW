...
/obj/effect/proc_holder/spell/invoked/funeral/cast(list/targets, mob/user = usr)
	...
	INVOKE_ASYNC(src, PROC_REF(try_furioso), user)

/obj/effect/proc_holder/spell/invoked/funeral/proc/try_furioso(mob/living/user, atom/target)
	SIGNAL_HANDLER
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso(mob/living/user)
	furioso_active = TRUE
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_start(mob/living/user, list/targets)
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_pick_target(list/targets)
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_attack(mob/living/user, mob/living/target, list/weapon_data, list/colors)
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_dash_to(mob/living/user, turf/destination, mob/living/target, beam_color)
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_hit(mob/living/user, mob/living/target, list/weapon_data, effect_type)
	if(QDELETED(user) || QDELETED(target))
		return
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_flurry(mob/living/user, mob/living/target, list/weapon_data, list/colors)
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_circle(mob/living/user, mob/living/target, list/weapon_data, list/colors)
	var/beam_color = colors[weapon_data["damtype"]]
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_dashthrough(mob/living/user, mob/living/target, list/weapon_data, list/colors, heavy)
	var/beam_color = colors[weapon_data["damtype"]]
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_lunge(mob/living/user, mob/living/target, list/weapon_data, list/colors)
	var/beam_color = colors[weapon_data["damtype"]]
	for(var/i in 1 to weapon_data["hits"])
		if(QDELETED(src) || QDELETED(user) || QDELETED(target))
			return
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_leapsmash(mob/living/user, mob/living/target, list/weapon_data, list/colors)
	for(var/i in 1 to weapon_data["hits"])
		if(QDELETED(src) || QDELETED(user) || QDELETED(target))
			return
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_charge(mob/living/user, mob/living/target, list/weapon_data, list/colors)
	var/beam_color = colors[weapon_data["damtype"]]
	for(var/i in 1 to weapon_data["hits"])
		if(QDELETED(src) || QDELETED(user) || QDELETED(target))
			return
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_ranged(mob/living/user, mob/living/target, list/weapon_data, list/colors)
	var/beam_color = colors[weapon_data["damtype"]]
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_reap(mob/living/user, mob/living/target, list/weapon_data, list/colors)
	if(QDELETED(src) || QDELETED(user) || QDELETED(target))
		return
...
/obj/effect/proc_holder/spell/invoked/funeral/proc/furioso_end(mob/living/user, list/targets)
	user.status_flags &= ~GODMODE
